...
//        mainPanel.setWhiteBallRandom(new Ball(Color.WHITE, (int) (Math.random() * 3) + 4, (int) (Math.random() * 3) + 4, 300));
        mainPanel.setWhiteBallRandom(new WhiteRandomBall(Color.WHITE, (int) (Math.random() * 3) + 4, (int) (Math.random() * 3) + 4, 300));
        Ball.setCount(0);
...
//                mainPanel.addBallToPanel(new Ball(Color.RED, 3, 2, 60));
                ...
                mainPanel.getWhiteBallRandom().registerObserver(redBall);
...
//                mainPanel.addBallToPanel(new Ball(Color.BLUE, 6, 4, 60));
                ...
                mainPanel.getWhiteBallRandom().registerObserver(blueBall);
