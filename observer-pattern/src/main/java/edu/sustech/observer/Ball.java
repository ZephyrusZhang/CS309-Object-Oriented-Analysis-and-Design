...
public class Ball extends JComponent {
    ...
    public boolean isIntersectWith(Ball other) {
        int dis = (this.getWidth() + other.getWidth()) / 2;
        double diffXPow = Math.pow(this.convertToCentralX() - other.convertToCentralX(), 2);
        double diffYPow = Math.pow(this.convertToCentralY() - other.convertToCentralY(), 2);
